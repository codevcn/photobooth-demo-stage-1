        ...
        >
          ...
          >
            <svg
              ...
              className="lucide lucide-rotate-cw-icon lucide-rotate-cw h-[18px] w-[18px] md:w-[28px] md:h-[28px]"
            >
        ...
        >
          ...
          >
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-scaling-icon lucide-scaling h-[18px] w-[18px] md:w-[28px] md:h-[28px]"
            >
        ...
        >
          ...
          >
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-x-icon lucide-x h-[18px] w-[18px] md:w-[28px] md:h-[28px]"
            >
              <path d="M18 6 6 18" />
              <path d="m6 6 12 12" />
            </svg>
